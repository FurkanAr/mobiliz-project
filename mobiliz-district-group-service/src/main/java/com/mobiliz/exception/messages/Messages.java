...
public class Messages {
    ...
    public static class CompanyDistrictGroup {
        ...
        public static final String NOT_EXISTS_BY_GIVEN_ADMIN_ID = "CompanyDistrictGroup cannot find with given admin id: ";
        ...
        public static final String COMPANY_FLEET_GROUP_ID_AND_COMPANY_ID_NOT_MATCHED = "Company fleet group id didn't matched given company id: ";
